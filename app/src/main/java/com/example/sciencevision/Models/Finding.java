...
public class Finding extends ParseObject {
    ...
    //Query
    public static class Query extends ParseQuery<Finding> {
        public Query() {
            super(Finding.class);
        }
    ...
    public static Finding createFinding(ParseUser User, String ItemName, String ItemDescription, String FunFact, ParseFile ItemImage, String Experiment) {
        final Finding newFinding = new Finding();
